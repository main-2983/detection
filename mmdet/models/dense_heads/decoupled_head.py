...
@HEADS.register_module()
class DecoupledHead_v8(ATSSHead):
    def __init__(self,
                 num_classes,
                 in_channels,
                 **kwargs):
        super(DecoupledHead_v8, self).__init__(
            num_classes,
            in_channels,
            **kwargs
        )
...
@HEADS.register_module()
class DecoupledHead_v9(ATSSHead):
    def __init__(self,
                 num_classes,
                 in_channels,
                 **kwargs):
        super(DecoupledHead_v9, self).__init__(
            num_classes,
            in_channels,
            **kwargs
        )
...
@HEADS.register_module()
class DecoupledHead_v10(ATSSHead):
    def __init__(self,
                 num_classes,
                 in_channels,
                 stacked_convs=3,
                 **kwargs):
        super(DecoupledHead_v10, self).__init__(
            num_classes,
            in_channels,
            stacked_convs=stacked_convs,
            **kwargs
    ...
    def forward_single(self, x, scale):
        ...
        center_pred = self.center_reg(self.semantic_branch[1](semantic_feat)).float()
        wh_pred = self.wh_reg(bounding_feat).float()
        bbox_pred = scale(torch.cat([center_pred, wh_pred], dim=1))
...
@HEADS.register_module()
class DecoupledHead_v12(ATSSHead):
    def __init__(self,
                 num_classes,
                 in_channels,
                 **kwargs):
        super(DecoupledHead_v12, self).__init__(
            num_classes,
            in_channels,
            **kwargs
        )
    ...
    def _init_layers(self):
        ...
        self.point_wise = nn.Conv2d(4, 4, 1)
    ...
    def forward_single(self, x, scale):
        ...
        wh_pred = self.wh_reg(reg_feat).float()
        bbox_pred = torch.cat([center_pred, wh_pred], dim=1)
        bbox_pred = self.point_wise(bbox_pred)
        bbox_pred = scale(bbox_pred).float()
